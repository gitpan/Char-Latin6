...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin6::function_ord     = 'Char::Latin6::ord'     if /\A ord \z/oxms;
                    $Char::Elatin6::function_ord_    = 'Char::Latin6::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin6::function_reverse = 'Char::Latin6::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin6::function_getc    = 'Char::Latin6::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin6::escape();
...
=head1 Calling 'Char::Elatin6::ignorecase()' (Char::Latin6 software provides)

Char::Latin6 software applies calling 'Char::Elatin6::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin6 software provides)

Char::Latin6 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin6 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin6 software provides)

Char::Latin6 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin6 software and
