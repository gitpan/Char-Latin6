...
######################################################################
#
# Char::Latin6 - Source code filter to Latin-6 script
#
...
sub Char::Latin6::escape_script {
    ...
    if (/^ use Char::Elatin6(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin6 %s;\n%s", $Char::Elatin6::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin6 - Source code filter to escape Latin-6

=head1 SYNOPSIS

  use Char::Latin6;
  use Char::Latin6 version;         --- require version
