...
BEGIN {
    ...
    sub Char::Elatin6::binmode(*;$);
    sub Char::Elatin6::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Elatin6::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Elatin6::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Elatin6::chr(65) is "A" in either ASCII or Latin-6, and
  Char::Elatin6::chr(0x82a0) is a Latin-6 HIRAGANA LETTER A. For the reverse of Char::Elatin6::chr,
  use Char::Latin6::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Elatin6::binmode(FILEHANDLE, $disciplines);
  Char::Elatin6::binmode(FILEHANDLE);
  Char::Elatin6::binmode($filehandle, $disciplines);
  Char::Elatin6::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Elatin6::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Elatin6::open(FILEHANDLE, $expr);
  $rc = Char::Elatin6::open(FILEHANDLE);
  $rc = Char::Elatin6::open(my $filehandle, $mode, $expr);
  $rc = Char::Elatin6::open(my $filehandle, $expr);
  $rc = Char::Elatin6::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Elatin6::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Elatin6::open my $fh, ">logfile" or die ...
  ...
  Char::Elatin6::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Elatin6::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Elatin6::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Elatin6::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Elatin6::open(FH, "<:crlf:encoding(Char::Latin6)", $path) or die "can't open $path: $!";
