...
#
# Latin-6 path globbing from File::DosGlob module
#
...
This module is a run-time routines of the Char/Latin6.pm.
Because the Char/Latin6.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a Latin-6 string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Elatin6::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Elatin6::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Latin-6 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Elatin6::fc function for case-insensitive comparisons via Char::Latin6
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Latin-6 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Latin-6 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Latin6 software, this function returns the full Unicode-like casefold of
  Latin-6 $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Elatin6::glob function grandfathers the use of whitespace to separate multiple
