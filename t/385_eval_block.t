...
# eval {...} has eval "..."
if (eval { eval Char::Latin6::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval Char::Latin6::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval Char::Latin6::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval Char::Latin6::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (eval { eval Char::Latin6::escape $var }) {
...
if (eval { eval Char::Latin6::escape }) {
