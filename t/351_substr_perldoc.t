...
my $color  = Char::Latin6::substr $s, 4, 5;   # black
my $middle = Char::Latin6::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Latin6::substr $s, 14;     # climebed the green tree
my $tail   = Char::Latin6::substr $s, -4;     # tree
my $z      = Char::Latin6::substr $s, -4, 2;  # tr
