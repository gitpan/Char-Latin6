...
=item Make character
  ...
  set. For example, Elatin6::chr(65) is "A" in either ASCII or Latin-6, not Unicode,
  and Elatin6::chr(0x82a0) is a Latin-6 HIRAGANA LETTER A. For the reverse of
  Elatin6::chr, use Latin6::ord.
