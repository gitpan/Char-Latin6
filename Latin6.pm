...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Elatin6::uc($char[$i]) ne Elatin6::lc($char[$i]))) {
...
http://search.cpan.org/dist/Char-Latin6/Latin6/JA.pm
