...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin6 software provides)

Latin6 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin6 software provide)
