...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin6::uc($char[$i]) ne Elatin6::lc($char[$i]))) {
            $char[$i] = '[' . Elatin6::uc($char[$i]) . Elatin6::lc($char[$i]) . ']';
        }
...
=item * Only Latin6.pm and Elatin6.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin6::lc
  lcfirst     Elatin6::lcfirst
  uc          Elatin6::uc
  ucfirst     Elatin6::ucfirst
  chr         Elatin6::chr
  glob        Elatin6::glob
  ---------------------------------
...
Latin6.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin6.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin6::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin6::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin6 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin6 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin6)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin6.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin6.pm provides bytes::*
